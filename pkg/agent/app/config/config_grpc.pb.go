...
func (c *syncConfigServiceClient) SyncConfig(ctx context.Context, in *SyncConfigRequest, opts ...grpc.CallOption) (*common.Empty, error) {
	...
	err := c.cc.Invoke(ctx, SyncConfigService_SyncConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSyncConfigServiceServer must be embedded to have
...
func (UnimplementedSyncConfigServiceServer) testEmbeddedByValue()                           {}
...
func RegisterSyncConfigServiceServer(s grpc.ServiceRegistrar, srv SyncConfigServiceServer) {
	// If the following call pancis, it indicates UnimplementedSyncConfigServiceServer was
