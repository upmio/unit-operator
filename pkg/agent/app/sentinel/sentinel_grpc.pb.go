...
const (
	SentinelOperation_UpdateRedisReplication_FullMethodName = "/sentinel.SentinelOperation/UpdateRedisReplication"
	SentinelOperation_SetVariable_FullMethodName            = "/sentinel.SentinelOperation/SetVariable"
)
...
func (c *sentinelOperationClient) UpdateRedisReplication(ctx context.Context, in *UpdateRedisReplicationRequest, opts ...grpc.CallOption) (*common.Empty, error) {
	...
	err := c.cc.Invoke(ctx, SentinelOperation_UpdateRedisReplication_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sentinelOperationClient) SetVariable(ctx context.Context, in *SetVariableRequest, opts ...grpc.CallOption) (*common.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.Empty)
	err := c.cc.Invoke(ctx, SentinelOperation_SetVariable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSentinelOperationServer must be embedded to have
...
func (UnimplementedSentinelOperationServer) testEmbeddedByValue()                           {}
...
func RegisterSentinelOperationServer(s grpc.ServiceRegistrar, srv SentinelOperationServer) {
	// If the following call pancis, it indicates UnimplementedSentinelOperationServer was
...
func _SentinelOperation_UpdateRedisReplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SentinelOperation_UpdateRedisReplication_FullMethodName,
	}
...
func _SentinelOperation_SetVariable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SentinelOperation_SetVariable_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
